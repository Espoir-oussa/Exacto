    ...
    <div class="flex items-center space-x-4 md:space-x-6 ml-auto md:pr-8">
        ...
        @if (auth()->user()->role === 'admin')
            <div class="relative" x-data="{ openNotif: false }" @click.outside="openNotif = false">
                <button @click="openNotif = !openNotif" class="hover:text-blue-200 transition-colors relative">
                ...
                <div x-show="openNotif" x-transition
                    class="absolute right-0 mt-2 w-72 sm:w-80 bg-white text-black rounded-md shadow-lg z-50">
                    <div class="p-4">
